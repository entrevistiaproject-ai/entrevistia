        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <AutoDecisionConfig
              ...
              autoApprovalMinScore={autoApprovalMinScore}
              onAutoApprovalMinScoreChange={setAutoApprovalMinScore}
              autoRejectEnabled={autoRejectEnabled}
              onAutoRejectEnabledChange={setAutoRejectEnabled}
              autoRejectMaxScore={autoRejectMaxScore}
              onAutoRejectMaxScoreChange={setAutoRejectMaxScore}
            />
          </CardContent>
        </Card>
