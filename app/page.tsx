    ...
    <div className="min-h-screen bg-linear-to-b from-background to-secondary/20">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 lg:py-40">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-block rounded-full bg-primary/10 px-5 py-2">
      ...
      {/* Stats Section */}
      <section className="border-y bg-background py-12 sm:py-16">
      ...
      {/* Benefits Section */}
      <section id="beneficios" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Recupere seu tempo</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Custo previsível</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Sem conflito de agenda</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Escale sem contratar</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Decisões embasadas</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <Card className="p-2">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-lg sm:text-xl">Tudo documentado</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
      ...
      {/* How It Works */}
      <section id="como-funciona" className="bg-secondary/30 py-16 sm:py-24 lg:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-12 sm:mb-16">
            <h2 className="mb-5 text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid gap-10 sm:gap-12 md:grid-cols-3">
              <div className="text-center">
                <div className="mx-auto mb-6 flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-full bg-primary text-2xl sm:text-3xl font-bold text-primary-foreground shadow-lg">
                  1
                </div>
                <h3 className="mb-3 text-lg sm:text-xl font-semibold">Monte sua entrevista</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="mb-3 text-lg sm:text-xl font-semibold">Convide candidatos</h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              ...
              <div className="text-center">
                ...
                <h3 className="mb-3 text-lg sm:text-xl font-semibold">Receba os resultados</h3>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <Card className="border-2 border-primary mb-10">
            <CardHeader className="text-center pb-4">
              <div className="mx-auto mb-3 inline-block rounded-full bg-primary/10 px-5 py-1.5">
            ...
            <CardContent className="text-center pt-2">
              ...
              <div className="bg-muted/50 rounded-lg p-5 mb-8">
                <p className="text-sm font-medium mb-3">Fórmula simples:</p>
                <p className="text-lg font-mono bg-background rounded px-4 py-2.5 inline-block">
          ...
          {/* O que está incluído */}
          <div className="grid gap-4 sm:gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-10">
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Ilimitado e gratuito</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 shrink-0" />
            ...
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Sem limite por vaga</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 shrink-0" />
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Incluída na análise</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 shrink-0" />
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Claude AI (Anthropic)</p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 rounded-lg border bg-card">
              <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 shrink-0" />
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Competências e insights</p>
              </div>
            </div>
          </div>

          {/* Free Trial */}
          <div className="text-center p-8 rounded-xl border-2 border-dashed border-primary/50 bg-primary/5">
            <h3 className="text-xl font-semibold mb-3">Ganhe R$ 50 em créditos ao criar sua conta</h3>
      ...
      {/* Use Cases */}
      <section id="casos-de-uso" className="bg-secondary/30 py-16 sm:py-24 lg:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center mb-12 sm:mb-16">
            <h2 className="mb-5 text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl">
      ...
      <section className="bg-primary py-16 sm:py-24 lg:py-32 text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-6 text-2xl font-bold tracking-tight sm:text-3xl md:text-4xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm opacity-75">
              <span className="flex items-center gap-2">
