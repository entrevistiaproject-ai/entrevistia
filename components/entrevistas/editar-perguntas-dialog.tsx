            ...
            <Alert className="mb-3 py-2.5 px-3 border-amber-200 bg-amber-50">
              <div className="flex gap-2">
                ...
                <p className="text-sm text-amber-700">
                  <span className="font-medium">Atenção:</span> Esta vaga já possui candidatos participando. Para garantir um processo justo, evite alterações significativas nas perguntas.
                </p>
              </div>
            </Alert>
          )}
